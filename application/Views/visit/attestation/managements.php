<div class="autocomplete" data-position-left="150px" data-position-top="45px">
    ...
    <div style="float: left; width: 55%; margin-top: 30px;">
        <div class="autocomplete" data-position-left="5px" data-position-top="60px">
            <label for="personForAPlannig">Оценивание в фокусе "Планирование":</label><br />
        ...
        <div class="autocomplete" data-position-left="5px" data-position-top="61px">
            <label for="personForATeaching">Оценивание в фокусе "Преподавание":</label><br />
            <input type="text" id="personForATeaching" name="personForATeaching" placeholder="Выбрать..." />
        </div>
        <div class="autocomplete" data-position-left="5px" data-position-top="60px">
            <label for="personForAEvaluating">Оценивание в фокусе "Оценивание учебных достижений":</label><br />
        ...
        <div class="autocomplete" data-position-left="5px" data-position-top="61px">
            ...
            <input type="text" id="personForAComplex" name="personForAComplex" placeholder="Выбрать..." style="margin-bottom: 36px;"/><br />
        </div>
    </div>
    <div style="float: right; width: 40%; margin-bottom: 10px; margin-top: 30px;">
        <label for="pAttestationDateFrom">Посещение с:</label>
        <label for="pAttestationDateTo" style="margin-left: 45px">по:</label><br />
        <input type="date" id="pAttestationDateFrom" name="pAttestationDateFrom"/>
        ...
        <label for="tAttestationDateTo" style="margin-left: 45px">по:</label><br />
        <input type="date" id="tAttestationDateFrom" name="tAttestationDateFrom"/>
        ...
        <label for="eAttestationDateTo" style="margin-left: 45px">по:</label><br />
        <input type="date" id="eAttestationDateFrom" name="eAttestationDateFrom"/>
        ...
        <label for="cAttestationDateTo" style="margin-left: 45px">по:</label><br />
        <input type="date" id="cAttestationDateFrom" name="cAttestationDateFrom"/>
        <input type="date" id="cAttestationDateTo" name="cAttestationDateTo" style="margin-top: 5px; margin-bottom: 15px;"/>
    </div><br />
